...
//                       className="flex items-center gap-4 p-4 rounded-lg bg-muted hover:bg-primary hover:text-primary-foreground transition-all group"
//                     >
//                       <IconComponent className="h-6 w-6" />
//                       <div>
...
//                   <h4 className="font-semibold mb-2 text-primary">What I'm looking for:</h4>
//                   <ul className="text-sm text-muted-foreground space-y-1">
//                     <li>• Data Analyst positions</li>
//                     <li>• Machine Learning projects</li>
//                     <li>• BI Developer roles</li>
//                     <li>• Freelance data science work</li>
//                   </ul>
//                 </div>
//               </CardContent>
//             </Card>
...
//                 Whether you're looking for a data analyst, need help with a machine learning project, 
//                 or want to discuss the latest trends in data science, I'm here to help.
//               </p>
