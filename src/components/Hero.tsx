...
//           {/* Content */}
//           <div className="lg:order-1 text-center lg:text-left max-w-2xl fade-in-up">
//             <div className="mb-6">
//               <p className="text-lg text-muted-foreground mb-2 slide-in-left">👋 Hi, I'm</p>
//               <h1 className="text-5xl lg:text-7xl font-bold mb-4 text-gradient">
//                 Shaik Fayaz
//               </h1>
...
//             {/* Stats */}
//             <div className="flex flex-col sm:flex-row gap-6 justify-center lg:justify-start text-center">
//               <div>
